...
--   ⚠️ 4-12 의 55-1번 도장포 15:45* → 해금강 16:10 도 **경로 문장**이다 — 55-1 고현발 회차의 해금강 칸 글
--      「가배(15:45)-저구-다대-다포-해금강(16:10)」. 도장포는 가배와 해금강 사이에 끼운 추정이라 15:45 는 가배 시각(하한)이고,
--      실제로는 15:45~16:10 사이에 지난다. 하루 한 편이다 — 놓치면 55번 17:45* → 17:55 로 해금강에 닿아(체류 53분) 18:48 복귀는 그대로다.
--      같은 편의 해금강 16:10 은 운영 중인 V20 코스 셋(거제 15:25 → 도장포 16:10*)도 이미 쓴다.
