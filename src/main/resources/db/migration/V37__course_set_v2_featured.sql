...
--   6 4-12 NINE     포로수용소 → (고현터미널) → 학동몽돌해변 → 바람의언덕 → 해금강
...
--     4-12 는 포로수용소 → 고현 둘 다 있는 편이 08:25 뒤로 14:15 까지 없어, 오전에 들르면 10:40 평일 편 하나가 휴일을 막는다.
--   · ⚠️ 포로수용소는 운영시간이 [미확인]이라 저녁에 닿지 않게 **맨 앞**에 둔다(2026-09-17 사용자 결정 — 옛 4-12 는 18:07 도착).
--     포로수용소는 고현터미널과만 이어져 맨 앞이면 되짚기가 그 뒤 한 번이다. 남부 세 곳 순서 여섯 중 넷이 성립하고 넷 다 휴일은 안 된다 —
--     마지막 스팟 도착이 가장 이른 학동 → 바람의언덕 → 해금강(16:10)을 골랐다. 나머지 셋은 16:50 도착이다
--     (학동 → 해금강 → 바람의언덕 · 해금강 → 바람의언덕 → 학동 · 바람의언덕 → 해금강 → 학동 — 원래 제안 순서).
--     5-04 는 포로수용소를 맨 앞에 두는 순서가 **하나도 성립하지 않아**(가장 가까운 사슬도 복귀 20:51) 맨 뒤 그대로다 — 사용자 결정 대기.
--   · 해금강 세 시간 머묾(4-11 · 3-12 의 11:55~14:48)은 55번 간격 탓이다 — 12:48 편은 해금강에 13:48 전에 닿아야 탄다.
--     4-12 의 16:10~18:48 도 같다 — 16:38 편은 해금강에 15:38 전에 닿아야 탄다.
...
--   옥포대첩기념공원 「1592년 옥포승첩을 기념 · 기념탑 · 이순신 장군」 · 포로수용소 「6·25 전쟁 · 포로수용소 부지 · 역사유적공원」 ·
...
FROM (VALUES
  ...
  (129, '포로수용소 · 학동몽돌해변 · 바람의언덕 · 해금강',
        '고현터미널 08:55 출발 → 19:40 복귀 · 약 11시간', '4-12', 4, 12, '08:55', '19:40', 645, 660,
        '포로수용소 유적에서 바다의 금강산까지',
        '거제시가 정한 거제 9경 가운데 1·2·4·6경을 봅니다. 6·25 전쟁 포로수용소 자리에 세운 유적공원에서 시작해 고현터미널을 거쳐, '
        '파도가 몽돌을 굴리는 학동 해변과 풍차가 선 바람의언덕을 지나 두 섬이 맞닿은 바위섬 해금강에서 마칩니다.'),
...
FROM (VALUES
  ...
  (129, 1, '포로수용소',       '09:07', '10:40',  93),
  (129, 2, '학동몽돌해변',     '11:45', '13:45', 120),
  (129, 3, '바람의언덕',       '13:55', '15:45', 110),
  (129, 4, '해금강',           '16:10', '18:48', 158),
...
FROM (VALUES
  ...
  -- 4-12 · 포로수용소는 고현터미널과만 이어진다(운영시간 [미확인]이라 저녁에 닿지 않게 맨 앞에 둔다)
  (129, 1, NULL,               '포로수용소',       'BUS',       '08:55', '09:07', 12),
  (129, 2, '포로수용소',       NULL,               'BUS',       '10:40', '10:50', 10),
  (129, 3, NULL,               '학동몽돌해변',     'BUS',       '11:05', '11:45', 40),
  (129, 4, '학동몽돌해변',     '바람의언덕',       'BUS',       '13:45', '13:55', 10),
  (129, 5, '바람의언덕',       '해금강',           'BUS',       '15:45', '16:10', 25),
  (129, 6, '해금강',           NULL,               'BUS',       '18:48', '19:40', 52),
  -- 5-04 · 포로수용소를 맨 뒤에 둔다
...
FROM (VALUES
  ...
  (129, 1, '100',   '고현',             '08:55', false, '포로수용소',       '09:07', true),
  (129, 2, '100',   '포로수용소',       '10:40', true,  '고현',             '10:50', false),  -- 평일만
  (129, 3, '55',    '고현',             '11:05', false, '학동',             '11:45', false),
  (129, 4, '55',    '학동',             '13:45', false, '도장포',           '13:55', true),
  (129, 5, '55-1',  '도장포',           '15:45', true,  '해금강',           '16:10', false),
  (129, 6, '55',    '해금강',           '18:48', false, '고현',             '19:40', false),
...
BEGIN
  ...
  FOR r IN
    ...
    FROM (VALUES
      ...
      ('4-12', '고현터미널>포로수용소 포로수용소>고현터미널 고현터미널>학동몽돌해변 학동몽돌해변>바람의언덕 바람의언덕>해금강 해금강>고현터미널',
               '100 08:55→09:07 | 100 10:40→10:50 | 55 11:05→11:45 | 55 13:45→13:55 | 55-1 15:45→16:10 | 55 18:48→19:40'),
